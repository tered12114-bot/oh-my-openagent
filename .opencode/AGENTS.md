...
Project-scope OpenCode configuration: 5 skills and 5 slash commands committed alongside the source. Picked up by [`src/features/opencode-skill-loader/`](../packages/omo-opencode/src/features/opencode-skill-loader) and the slash-command discovery pipeline.
